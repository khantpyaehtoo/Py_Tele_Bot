...
# Tempo Save CLASS and Ask for STUDENTID
...
# Tempo Save STUDENTID and Ask for ATTCODE
...
# Tempo Save ATTCODE and insert to DB
...
async def report(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        records = list(
            collection.find({"user_id":user_id}).sort("createdAt",-1) # pymongo.ASCENDING
        )
